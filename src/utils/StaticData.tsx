...
import type { aboutData, staticCard } from "../Model/ModelData";
...
const aboutSectionData: aboutData[] = [
  {
    title: "Frameworks and Technologies Used",
    description:
    ...
    icons: [
      {
        icon: (
          <svg
            ...
            role="img"
            viewBox="0 0 24 24"
            className="hover:text-[#149ECA] transition-all ease duration-300 w-9 h-9 text-gray-400"
      ...
      },
      {
        icon: (
          <svg
            ...
            role="img"
            viewBox="0 0 24 24"
            className="hover:text-[#38bdf8] transition-all ease duration-300 w-9 h-9 text-gray-400"
            height="1em"
            width="1em"
            xmlns="http://www.w3.org/2000/svg"
          >
  ...
  },
  {
    ...
    icons: [
      {
        href: "https://www.linkedin.com/in/mherdianbayup/",
        icon: (
          <svg
            stroke="currentColor"
            fill="currentColor"
            strokeWidth="0"
            viewBox="0 0 448 512"
            className="hover:text-[#0077b5] transition-all ease duration-300 w-9 h-9 text-gray-400"
            xmlns="http://www.w3.org/2000/svg"
          >
      ...
      {
        href: "https://github.com/HerdianBay",
        icon: (
          <svg
            stroke="currentColor"
            fill="currentColor"
            strokeWidth="0"
            viewBox="0 0 496 512"
            className="hover:text-black transition-all ease duration-300 w-9 h-9 text-gray-400"
            xmlns="http://www.w3.org/2000/svg"
          >
