    ...
    icons: [
      {
        icon: (
          <svg
            ...
            role="img"
            viewBox="0 0 24 24"
            className="hover:text-[#149ECA] transition-all ease duration-300 w-9 h-9 text-gray-400 md:w-10 md:h-10 lg:w-12 lg:h-12 xl:w-14 xl:h-14"
      ...
      },
      {
        icon: (
          <svg
            ...
            role="img"
            viewBox="0 0 24 24"
            className="hover:text-[#38bdf8] transition-all ease duration-300 w-9 h-9 text-gray-400 md:w-10 md:h-10 lg:w-12 lg:h-12 xl:w-14 xl:h-14"
            height="1em"
            width="1em"
            xmlns="http://www.w3.org/2000/svg"
          >
    ...
    icons: [
      {
        ...
        icon: (
          <svg
            ...
            strokeWidth="0"
            viewBox="0 0 448 512"
            className="hover:text-[#0077b5] transition-all ease duration-300 w-9 h-9 text-gray-400 md:w-10 md:h-10 lg:w-12 lg:h-12 xl:w-14 xl:h-14 "
            xmlns="http://www.w3.org/2000/svg"
          >
      ...
      },
      {
        ...
        icon: (
          <svg
            ...
            strokeWidth="0"
            viewBox="0 0 496 512"
            className="hover:text-black transition-all ease duration-300 w-9 h-9 text-gray-400 md:w-10 md:h-10 lg:w-12 lg:h-12 xl:w-14 xl:h-14"
            xmlns="http://www.w3.org/2000/svg"
          >
